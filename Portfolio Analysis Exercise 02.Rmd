...
Here we will define risk-free asset is something like money market fund or simply Bank Account. It is depends on you what you want to choose. Money market fund is actually not 100% risk-free. Depends on the composition of the fund, if the risk is small enough, we can safely ignore it.
...
Rolling estimation. 
The tricky part here is to choose the window length? How should we choose the window length?
